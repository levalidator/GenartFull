...
<h1>
	...
	<c:out value="${ template.getName() }" />
</h1>
</section> </header>

<section class="content"> <section class="container-fluid">
<div class="span8">
	<div id="info-oeuvre">
		<p>
...
<div class="span8" id="app-span">
	<canvas id="${template.getNamePde() }"
		data-processing-sources="${ template.getPdePath() }"></canvas>
	...
	<div class="span1">
		Oeuvre : <span id="badge-price-oeuvre"
			data-price-oeuvre="${ template.getMontant() }" class="badge"><c:out
				value="${ template.getMontant() }" />€</span>
	</div>
	<div class="span1">
		Support : <span id="badge-price-support" class="badge">0€</span>
	</div>
	<div class="span1">
		Total : <span id="badge-price-total" class="badge"><c:out
				value="${ template.getMontant() }" />€</span>
	</div>
...
<h2>Les oeuvres du meme artiste</h2>
</section> <c:forEach items="${ requestScope['templates'] }" var="fetemplate">
	<article class="span4 article-thumb"> <figure> <img
		src="${ fetemplate.getImage() }" /> <section class="pict-descr">
	<h4>
		Titre :
		<c:out value="${ fetemplate.getName() }" />
	</h4>
	<p>
		Auteur :
	...
	<p>
		<c:out value="${ fetemplate.getDescription() }" />
	</p>
	<a href="details?id=${ fetemplate.getId() }" class="button green">en
		savoir plus</a> </article>
</c:forEach> </section> </section>
